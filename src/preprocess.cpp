...
void Preprocess::process(const livox_ros_driver::CustomMsg::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_full, PointCloudXYZI::Ptr &pcl_surf, PointCloudXYZI::Ptr &pcl_corn)
{  
  avia_handler(msg);
...
void Preprocess::process(const sensor_msgs::PointCloud2::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_full, PointCloudXYZI::Ptr &pcl_surf, PointCloudXYZI::Ptr &pcl_corn)
{
  switch (lidar_type)
  {
  case OUST64:
