...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process(const livox_ros_driver::CustomMsg::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_full, PointCloudXYZI::Ptr &pcl_surf, PointCloudXYZI::Ptr &pcl_corn);
  void process(const sensor_msgs::PointCloud2::ConstPtr &msg, PointCloudXYZI::Ptr &pcl_full, PointCloudXYZI::Ptr &pcl_surf, PointCloudXYZI::Ptr &pcl_corn);
